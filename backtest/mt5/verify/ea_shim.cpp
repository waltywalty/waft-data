...
// [stripped] #property version   "1.20"
...
bool            InpLogDiagnostics = true;       // Log candidate signals per trade
string          InpDiagFile       = "AsiaOpenGold_forward_v2.csv"; // CSV in MQL5\Files
